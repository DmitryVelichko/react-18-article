---
title: "Язык программирования Dart. Основы."
date: 2022-04-27T14:00:00+03:00
authors: ["dmitry-velichko"]
draft: false
categories: ["Обзор"]
tags: ["Dart"]
---
...
Сегодня мы с вами поговорим о языке программирования, который, вероятнее всего, придет в скором будущем на замену всеми нами любимому JavaSript. Этот язык разработала компания Google и он называется Dart.

Dart — это язык программирования общего назначения, который предназначен прежде всего для разработки веб-приложений (как на стороне клиента, так и на стороне сервера) и мобильных приложений. Это также значит, что одну и ту же программу на Dart можно компилировать под различные платформы — Windows, Android, iOS.
